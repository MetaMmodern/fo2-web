...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "FlatOut2.Telemetry.ReloadedII.TemplateProbe.csproj",
    $PackageName = "FlatOut2.Telemetry.ReloadedII.TemplateProbe",
    ...
    $NuGetPackageId = "FlatOut2.Telemetry.ReloadedII.TemplateProbe",
