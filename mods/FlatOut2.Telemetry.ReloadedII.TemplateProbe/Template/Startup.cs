...
using FlatOut2.Telemetry.ReloadedII.TemplateProbe.Template.Configuration;
using FlatOut2.Telemetry.ReloadedII.TemplateProbe.Configuration;

namespace FlatOut2.Telemetry.ReloadedII.TemplateProbe.Template;
